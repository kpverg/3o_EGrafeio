...
class kataxwrhsheggrafou(QWidget):
    ...
    def widgets(self):
        ...
        self.dteggradouEntry.setPlaceholderText("της μορφης..3 Απρ 2021")
        ...
        self.monadaEntry.setText( "33 EMA/3o Γρ")
    ...
    def layouts(self):
        ...
        self.bottomleftLayout.addWidget(self.eiserxomeno)
        self.bottomleftLayout.addWidget(self.renamer)
        self.bottomleftLayout.addWidget(self.arxeiothetisibtn)
        self.bottomleftLayout.addStretch(1)
        ### widget form Layout#####
